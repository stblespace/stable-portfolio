...
export default function About() {
  ...
  return (
    <section id="about" className="py-32 px-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="gradient-border-hover lg:col-span-2 rounded-2xl">
            <div className="bg-neutral-900 rounded-2xl p-10 h-full">
          ...
          <div className="gradient-border-hover rounded-2xl">
            <div className="bg-neutral-900 rounded-2xl p-2 flex flex-col h-full">
              <div className="relative h-96 bg-neutral-800 rounded-xl min-h-80 flex-1 flex items-center justify-center">
                <Image
                  src="/cat.jpg"
          ...
          <div className="gradient-border-hover rounded-2xl lg:col-span-3">
            <div className="lg:col-span-3 rounded-2xl bg-neutral-900 p-10">
