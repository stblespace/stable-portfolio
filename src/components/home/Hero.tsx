...
export function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center px-6 pt-24">
      <div className="max-w-3xl w-full text-center">
        ...
        {/* Имя */}
        <h1 className="text-4xl sm:text-6xl md:text-6xl font-bold text-white mb-4">
          Алексей Воробьев
        </h1>
